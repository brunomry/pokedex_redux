    ...
    <section className="container-fluid bannerHome d-flex justify-content-center px-0">
      <div className="bannerContent row gy-5 justify-content-center mt-4 mt-md-0 text-white">
        ...
        <img src={pokedex} alt="" className='img-fluid' width={200}/>
          <h1 className="text-center fw-bold ">Sumérgete en el Mundo Pókemon</h1>
          <p className="text-start lead fs-4">¡Busca tus pokemones favoritos!</p>
          <Button className="fs-4 btnBanner border-1 border-white rounded-5 py-3">¡Descúbrelos aquí!</Button>
        </div>
